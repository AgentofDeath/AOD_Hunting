...
local HuntAnimals = {"a_c_deer", "a_c_coyote", "a_c_boar"}
local spawnDistanceRadius = math.random(50,65)
local baitexists = 0
local baitLocation = nil
DecorRegister("MyAnimal", 2)
local validHuntingZones = {'CMSW' , 'SANCHIA', 'MTGORDO', 'MTJOSE', 'PALHIGH'}
local HuntedAnimalTable = {}
local busy = false
local valid = false
